...
handler.all = async function(m) {
    ...
    try {
        ...
        global.kontak2 = [
            [owner[0], await conn.getName(owner[0] + '201122522729@s.whatsapp.net'), 'Tio', 'https://whatsapp.com', true],
        ]
        ...
        global.fVerif = {
            key: {
                participant: '201122522729@s.whatsapp.net',
                remoteJid: "201122522729@s.whatsapp.net"
            },
            message: {
